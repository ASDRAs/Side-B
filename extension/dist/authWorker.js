var SideBAuthBundle = (() => {
  ...
  // node_modules/@firebase/auth/dist/web-extension-esm/register-CPcgXhGD.js
  ...
  function createAuthManager({
    ...
    function trustedOrigin(value) {
      ...
      if (url.pathname !== "/" || url.search || url.hash || url.username || url.password || !config?.trustedBackendOrigins?.includes(url.origin)) {
    ...
    async function initializeFirebase(projectId) {
      ...
      if (![firebase.apiKey, firebase.authDomain, firebase.projectId, firebase.appId].every(Boolean) || firebase.projectId !== projectId) {
    ...
    function configure(apiBaseUrl) {
      ...
      void promise.finally(() => {
        if (configuring?.promise === promise) configuring = null;
      });
      return promise;
    }
    function signIn() {
...
@firebase/util/dist/index.esm.js:
@firebase/util/dist/index.esm.js:
@firebase/auth/dist/web-extension-esm/register-CPcgXhGD.js:
  (**
   * @license
