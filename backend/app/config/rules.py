...
SIMPLE_TAG_RULES: tuple[tuple[tuple[str, ...], list[str]], ...] = (
    (
        ...
        ["focus", "instrumental", "lo-fi"],
    ),
    (
        ("workout", "run", "running", "gym", "exercise", "운동", "헬스", "러닝"),
        ["workout", "energetic", "dance"],
    ),
    (
        ("drive", "driving", "road", "드라이브", "운전"),
        ["road-trip", "indie", "feel-good"],
    ),
    (("commute", "출근", "퇴근"), ["commute", "chill", "pop"]),
    (
        ("sleep", "relax", "relaxing", "잠", "수면", "휴식"),
        ["sleep", "ambient", "calm"],
    ),
